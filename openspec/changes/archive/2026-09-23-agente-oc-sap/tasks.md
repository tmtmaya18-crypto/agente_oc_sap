...
- [x] 9.6 Batería de pruebas con el modelo real sobre los 6 casos y variantes (cancelar, preguntas del proceso, caso inexistente, mensajes ambiguos); registrar hallazgos
- [x] 9.4 Prueba manual local con clave: prompt de la sección 11 del PRD + "confirmo", "Crea la OC de sol-003", "Crea la OC de sol-001 otra vez"; commit
